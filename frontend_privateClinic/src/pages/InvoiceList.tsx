          ...
          <table className="w-full">
            <thead className="bg-[#1250B1] text-white">
              <tr>
                ...
                <th className="px-6 py-3 text-left">Examination Date</th>
                <th className="px-6 py-3 text-left">Consultant Fee</th>
                <th className="px-6 py-3 text-left">Total Medicine Fee</th>
              ...
              {loading ? (
                ...
                invoices.map((invoice) => (
                  <tr key={invoice.id} className="border-b hover:bg-gray-50">
                    <td className="px-6 py-4 text-black">{invoice.id}</td>
                    <td className="px-6 py-4 text-black">
                      {invoice.patientName}
                    </td>
                    <td className="px-6 py-4 text-black">
                      {invoice.examinationDate}
                    </td>
                    <td className="px-6 py-4 text-black">
                      {formatCurrency(invoice.consultantFee)}
                    </td>
                    <td className="px-6 py-4 text-black">
                      {formatCurrency(invoice.totalMedicineFee)}
                    </td>
