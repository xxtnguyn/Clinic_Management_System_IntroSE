  ...
  static async findAll(options = {}) {
    ...
    if (phone) {
      ...
      if (phoneNumber) {
        ...
        conditions.push(
          `REPLACE(p.phone, ' ', '') LIKE $${queryParams.length}`
        );
      }
    }
      ...
      if (error.code === "23505") {
        ...
        if (
          ...
          throw new DatabaseError(
            ...
            `Thời gian ${data.appointment_time} ngày ${data.appointment_date} đã có lịch hẹn khác`,
    ...
    try {
      ...
      if (error.code === "23505") {
        ...
        if (
          ...
          throw new DatabaseError(
            "Thời gian đã có lịch hẹn khác",
            `Thời gian ${data.appointment_time || "unknown"} ngày ${data.appointment_date || "unknown"} đã có lịch hẹn khác`,
            "Vui lòng chọn thời gian khác"
          );
        }
      }
